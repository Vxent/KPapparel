...
$query = "SELECT id, name, description, price, size, image_url FROM products LIMIT $products_per_page OFFSET $offset";
    ...
    <?php if ($result->num_rows > 0): ?>
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td class="text-left py-3 px-3"><?php echo htmlspecialchars($row['size']); ?></td> <!-- Display size here -->
